...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-academic-900 text-white hover:bg-academic-800 focus:ring-academic-900 shadow-md hover:shadow-lg",
    secondary: "bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500 shadow-sm",
    outline: "border border-academic-300 bg-white text-academic-700 hover:bg-academic-50 focus:ring-academic-200"
  };
